...
var _SabrStreamingAdapter = class _SabrStreamingAdapter {
  ...
  addBufferingInfoToAbrRequest(videoPlaybackAbrRequest, currentFormat, activeFormats) {
    ...
    for (const activeFormat of Object.values(activeFormats)) {
      ...
      const bufferedRange = shouldDiscard ? this.createFullBufferRange(activeFormat) : this.createPartialBufferRange(initializedFormat, (_a = videoPlaybackAbrRequest.clientAbrState) == null ? void 0 : _a.playerTimeMs);
      if (bufferedRange) {
   ...
   */
  createPartialBufferRange(initializedFormat, playerTimeMs) {
    if (!(initializedFormat == null ? void 0 : initializedFormat.lastSegmentMetadata))
      return null;
    if (playerTimeMs !== void 0 && playerTimeMs < initializedFormat.lastSegmentMetadata.startTimeMs) {
      return null;
    }
